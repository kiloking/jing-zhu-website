  ...
  return (
    ...
    >
      ...
      <div className=' absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/12 '>
        ...
        <img src='./images/header_title.png' alt="" className='my-[13%] w-3/4 mx-auto' data-aos="fade-up" data-aos-delay="00" data-aos-offset="-100" data-aos-duration="800"/>
      </div>
      <div className='w-full'>
        <img src="./images/header_subtitle.png" alt="" className='w-full' data-aos="fade" data-aos-duration="1000"/>
      </div>
    </div>
  )
}
